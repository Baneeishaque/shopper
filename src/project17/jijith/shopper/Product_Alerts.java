...
public class Product_Alerts extends Activity {
	...
	private void get_product_notifications() {
		// TODO Auto-generated method stub
		try {
			httpcnt = new DefaultHttpClient();
			httpost = new HttpPost("http://" + General_Data.SERVER_IP_ADDRESS
					+ "/android-billing-server/android/get_product_alerts.php");
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					// TODO Auto-generated method stub
					Toast.makeText(Product_Alerts.this, response, Toast.LENGTH_LONG).show();
					pd.dismiss();
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					// TODO Auto-generated method stub
					Toast.makeText(Product_Alerts.this, "Error : " + e.getLocalizedMessage(), Toast.LENGTH_LONG).show();
					Log.d(General_Data.TAG, e.getLocalizedMessage());
					pd.dismiss();
				}
			});
